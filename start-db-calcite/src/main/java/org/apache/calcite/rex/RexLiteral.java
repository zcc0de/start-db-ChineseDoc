...
/** 实现rexliteral：常量表达式，行表达式rexnode 的一种
 ...
 * </p>
 *
 * <p>  包含常量的值和类型，值可以通过getvalue方法获取，类型对外隐藏
...
public class RexLiteral extends RexNode {
    ...
    /** 指示一个sqltype，不一定对应，例如各种数字类型int，tinyint，float等等都指示为decimal
