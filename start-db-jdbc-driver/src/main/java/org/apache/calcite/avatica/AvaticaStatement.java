...
public abstract class AvaticaStatement implements Statement {
    ...
    //  Connection：建立与数据库的连接，可以创建statement或preparedstatement
    public final AvaticaConnection connection;

    /** handle 句柄 (statement对象的id)
    ...
    /** avaticastatement 构造方法
     * Creates an AvaticaStatement.
     *
     * @param connection           Connection
     * @param h                    Statement handle
     * @param resultSetType        Result set type
     * @param resultSetConcurrency Result set concurrency   并行性
     * @param resultSetHoldability Result set holdability   可保留性
     */
    //  无签名signature
    ...
    //  检查当前statement是否是prepared或calllable型
