...
/** 实现数据表元数据类 columnmetadata
 * avaticatype是columnmeta的成员，rep是avaticatype的成员
...
public class ColumnMetaData {
    ...
    public enum Rep {
        ...
        //  获取查询结果中指定列的值，根据列的数据类型调用相应的get方法
        ...
        /** 返回指定基本数据类型的rep，如果指定的不为基本数据类型，还是返回相应类型rep
