...
public abstract class AbstractCursor implements Cursor {
    ...
    static class AccessorImpl implements Accessor {
        ...
        // 将访问到的数据转换为各种数据类型，只能转换为object和string类型，其他类型由具体子类实现
        // 无法转换的抛出错误，输出"cannot convert to " + targetType + " (" + this + ")"
    ...
    /** Getter实现  SlotGetter get一个可变slot
    ...
    /** Getter实现  StructGetter get另一个getter由参数columnmetadata指定列的值
